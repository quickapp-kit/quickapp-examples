...
async function main() {
  ...
  try {
    ...
    const js = new JsModuleEmitter().emit({ model: lowered.model, cancellation: cancellation() })
    ...
    const metadata = {
      status: 'PASS',
      case: caseName,
      sourceManifest: `quickapp-examples/showcases/${caseName}/src/manifest.json`,
      packagePath: `quickapp-examples/showcases/${caseName}/dist/${caseName}.rpk`,
